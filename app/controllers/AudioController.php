...
class AudioController extends BaseController {
	...
	public function merge(){
		if(Input::has('submitted')){
			...
			echo shell_exec("/usr/local/bin/ffmpeg -ss -t 30 /Applications/MAMP/htdocs/yoga_audio/yoga_audio/public/audio/subcat".$sid.".mp3"." /Applications/MAMP/htdocs/yoga_audio/yoga_audio/public/audio/30subcat".$sid.".mp3");
